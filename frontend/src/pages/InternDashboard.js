...
export default function InternDashboard() {
  ...
  const handleMcqSubmit = () => {
    ...
    setMcqGrade(score);
    setMcqDone(true);
    console.log(`MCQ Test submitted! Score: ${score}%. Part A completed.`);
  ...
  const handleSubmitCode = () => {
    ...
    setTimeout(() => {
      ...
      console.log(`Coding assessment submitted! Score: ${randomScore}%. Part B completed.`);
      setCodingDone(true);
      setAssessmentView("selection");
    }, 2000);
  };
  ...
  const handleCompleteDay = () => {
    console.log(`Day ${currentDay} complete! Day ${currentDay + 1} will unlock at 12:00 AM.`);
                ...
                <div>
                  ...
                  <div style={{ padding: "12px", backgroundColor: "#fff", borderRadius: "8px", border: "1px solid #e2e8f0" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "8px" }}>
                      ...
                      <button className="btn btn-primary" style={{ padding: "6px 12px", fontSize: "12px", backgroundColor: "#3b82f6", border: "none" }} onClick={() => console.log("Joining mock Zoom room...")}>Join</button>
                    </div>
                  </div>
                </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div style={{ marginTop: "8px", display: "flex", justifyContent: "flex-end" }}>
                  <button className="btn btn-primary" style={{ backgroundColor: "#b91c1c", borderColor: "#b91c1c" }} onClick={() => {
                    console.log("Ticket submitted successfully! Admin will review it shortly.");
            ...
            <div className="card" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "24px" }}>
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px", background: "#f3f4f6", padding: "10px 16px", borderRadius: "8px", width: "fit-content" }}>
                  ...
                  <button onClick={() => console.log(`Downloading ${currentCurriculum.notes}`)} style={{ background: "none", border: "none", color: "#2563eb", fontWeight: "600", cursor: "pointer", fontSize: "13px", padding: 0, textDecoration: "underline" }}>Download PDF Notes</button>
                </div>
              </div>
                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Today, 3:00 PM</td>
                      <td>
                        <button onClick={() => console.log("Joining mock Zoom room...")} className="btn btn-primary" style={{ padding: "4px 8px", fontSize: "12px" }}>Join zoom</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
