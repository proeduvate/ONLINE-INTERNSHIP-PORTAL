          ...
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px", marginTop: "24px", marginBottom: "24px" }}>
              <div className="card" style={{ margin: 0, padding: "24px", backgroundColor: "#fef3c7", border: "1px solid #fbbf24" }}>
                <h3 style={{ margin: "0 0 16px 0", display: "flex", alignItems: "center", gap: "8px" }}>≡ƒÄü Bonus Airdrops</h3>
              ...
              <div className="card" style={{ margin: 0, padding: "24px", backgroundColor: "#eff6ff", border: "1px solid #bfdbfe" }}>
                <h3 style={{ margin: "0 0 16px 0", display: "flex", alignItems: "center", gap: "8px" }}>≡ƒñö Daily Scenario</h3>
                  ...
                  <div style={{ padding: "12px", backgroundColor: "#fff", borderRadius: "8px", border: "1px solid #e2e8f0" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "8px" }}>
                      <div>
                        ...
                        <span style={{ fontSize: "12px", color: "#64748b" }}>Host: Dr. Sakthi ΓÇó Today, 3:00 PM</span>
                      </div>
              ...
              <div className="card" style={{ margin: 0, padding: "24px" }}>
                ...
                <div className="table-container">
                  <table className="table">
                    ...
                    <tbody>
                      {[
                        { rank: 1, name: "Anu Sharma", domain: "Cyber Security", points: 950, badge: "≡ƒÑç Gold" },
                        { rank: 2, name: "Raj Patel", domain: "Data Science", points: 880, badge: "≡ƒÑê Silver" },
                        { rank: 3, name: "John Doe (You)", domain: "Artificial Intelligence", points: 850, badge: "≡ƒÑë Bronze", isCurrent: true },
          ...
          return (
            <div className="card">
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
                <h3 style={{ margin: 0, color: "#b91c1c", display: "flex", alignItems: "center", gap: "8px" }}>ΓÜá∩╕Å File a Support Ticket</h3>
                ...
                <div className="card" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
                    <div className="card" style={{ margin: 0, textAlign: "center", border: "1px solid #e5e7eb", background: mcqDone ? "#ecfdf5" : "#fff" }}>
                      ...
                      {mcqDone ? (
                        <span style={{ color: "#10b981", fontWeight: "bold", fontSize: "14px" }}>Γ£ô Completed</span>
                      ) : (
          ...
          <div className="card" style={{ margin: 0, padding: 0, height: "calc(100vh - 120px)", display: "flex", flexDirection: "column", overflow: "hidden", borderRadius: "12px", border: "1px solid #e2e8f0" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", padding: "16px 20px", backgroundColor: "#1e293b", color: "#ffffff" }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: "12px", color: "#94a3b8" }}>Mentor ΓÇó Online</p>
              </div>
            </div>
                ...
                <div key={i} style={{ alignSelf: msg.sender === "You" ? "flex-end" : "flex-start", maxWidth: "70%", position: "relative", marginBottom: "8px" }}>
                  <div style={{ 
                    ...
                    <span style={{ fontSize: "10px", color: msg.sender === "You" ? "#bfdbfe" : "#94a3b8", position: "absolute", bottom: "6px", right: "12px" }}>
                      {msg.time} {msg.sender === "You" && "Γ£ôΓ£ô"}
                    </span>
                  </div>
                </div>
              ))}
