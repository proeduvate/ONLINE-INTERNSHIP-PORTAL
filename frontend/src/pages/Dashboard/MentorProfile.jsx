              ...
              <form onSubmit={(e) => { e.preventDefault(); alert("Profile saved"); }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                  <div>
                    ...
                    <input type="text" defaultValue="Ananya" disabled style={{ width: "100%", padding: "8px 14px", borderRadius: "8px", border: "1px solid #cbd5e1", outline: "none", fontSize: "0.9rem", color: "#64748b", background: "#f1f5f9", cursor: "not-allowed" }} />
                  </div>
                  <div>
                    <label style={{ display: "block", fontSize: "0.85rem", fontWeight: 600, color: "#334155", marginBottom: "6px" }}>Last Name</label>
                    <input type="text" defaultValue="Menon" disabled style={{ width: "100%", padding: "8px 14px", borderRadius: "8px", border: "1px solid #cbd5e1", outline: "none", fontSize: "0.9rem", color: "#64748b", background: "#f1f5f9", cursor: "not-allowed" }} />
                  </div>
                </div>
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    <input type="email" defaultValue="ananya@proedu.com" disabled style={{ width: "100%", padding: "8px 14px 8px 38px", borderRadius: "8px", border: "1px solid #cbd5e1", outline: "none", fontSize: "0.9rem", color: "#64748b", background: "#f1f5f9", cursor: "not-allowed" }} />
                  </div>
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                  <div>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input type="text" defaultValue="Artificial Intelligence" style={{ width: "100%", padding: "8px 14px 8px 38px", borderRadius: "8px", border: "1px solid #cbd5e1", outline: "none", fontSize: "0.9rem", color: "#0f172a" }} />
                    </div>
                  </div>
                  <div>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input type="text" defaultValue="IIT Madras" style={{ width: "100%", padding: "8px 14px 8px 38px", borderRadius: "8px", border: "1px solid #cbd5e1", outline: "none", fontSize: "0.9rem", color: "#0f172a" }} />
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                  <div>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input type="text" defaultValue="AI Mentor & Researcher" style={{ width: "100%", padding: "8px 14px 8px 38px", borderRadius: "8px", border: "1px solid #cbd5e1", outline: "none", fontSize: "0.9rem", color: "#0f172a" }} />
                    </div>
                  </div>
                  <div>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input type="text" defaultValue="Chennai, India" style={{ width: "100%", padding: "8px 14px 8px 38px", borderRadius: "8px", border: "1px solid #cbd5e1", outline: "none", fontSize: "0.9rem", color: "#0f172a" }} />
                    </div>
                  </div>
                </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                {[
                  ...
                  <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                      <h5 style={{ margin: "0 0 4px 0", fontSize: "0.95rem", color: "#0f172a" }}>{n.title}</h5>
                      <p style={{ margin: 0, fontSize: "0.85rem", color: "#64748b" }}>{n.desc}</p>
                    </div>
