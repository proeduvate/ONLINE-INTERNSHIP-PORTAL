...
export default function AdminDashboard() {
  ...
  const handleAddUser = (e) => {
    e.preventDefault();
    if (!newUser.name) return console.log("Please specify user name.");
  ...
  const handleAddMentor = (e) => {
    e.preventDefault();
    if (!newMentor.name || !newMentor.email) return console.log("Please specify name and email.");
    const added = {
    ...
    setUsersList([...usersList, added]);
    console.log("Verification link sent to mentor's email!");
  ...
  const handleCreateTask = (e) => {
    e.preventDefault();
    if (!newTask.title) return console.log("Please specify task title.");
    const created = {
      id: tasks.length + 1,
      title: newTask.title,
    ...
    console.log("New task created and assigned successfully!");
    setNewTask({ title: "", description: "", difficulty: "Medium", deadline: "", domain: "" });
  };

  const handleUploadCurriculum = (e) => {
    e.preventDefault();
    if (!newCurriculum.day || !newCurriculum.topic) return console.log("Fill day & topic.");
    setCurriculumList([...curriculumList, newCurriculum]);
    console.log("Curriculum content uploaded!");
    setNewCurriculum({ day: "", topic: "", resources: "", domain: "Web Development" });
  };

  const handleScheduleMeeting = (e) => {
    e.preventDefault();
    if (!newMeeting.title) return console.log("Enter meeting title.");
    const scheduled = {
  ...
  const enrollCandidate = (id) => {
    ...
    console.log(`${candidate.name} has been enrolled successfully!`);
  };

  const handleAddDomain = (e) => {
    e.preventDefault();
    if (!newDomain.name || !newDomain.duration) return console.log("Fill all fields.");
    const added = {
      name: newDomain.name,
    ...
    console.log("New Domain Added Successfully!");
              ...
              <table className="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <button onClick={() => console.log("Certificate generated for Raj Patel! Verification Key: CERT-DS-884")} className="btn btn-primary" style={{ padding: "6px 12px", fontSize: "12px" }}>
                        Generate & Email
                      </button>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <button onClick={() => console.log("Certificate generated for Anu Sharma! Verification Key: CERT-CS-122")} className="btn btn-primary" style={{ padding: "6px 12px", fontSize: "12px" }}>
                        Generate & Email
                      </button>
                    </td>
                  </tr>
